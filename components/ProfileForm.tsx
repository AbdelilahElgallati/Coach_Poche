...
import { User, Weight, Ruler, Dumbbell, Activity, Target, Loader2, Calendar, CheckSquare } from "lucide-react";
...
export default function ProfileForm({ onSubmit, isLoading, initialData }: ProfileFormProps) {
  ...
  const handleChange = (
    ...
    setProfile((prev) => {
      ...
      // Reset equipment if sport changes (optional but cleaner)
      if (name === "sport") {
        updated.equipment = [];
      }
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-6 mb-6">
        ...
        <div className="space-y-2">
          ...
          <select
            ...
            onChange={handleChange}
            className="w-full rounded-lg border-gray-200 bg-gray-50 focus:bg-white focus:border-indigo-500 focus:ring-2 focus:ring-indigo-200 transition-all p-3 outline-none"
          >
        ...
        <div className="space-y-2">
          ...
          <div className="relative">
            <select
              ...
              onChange={handleChange}
              className="w-full rounded-lg border-gray-200 bg-gray-50 focus:bg-white focus:border-indigo-500 focus:ring-2 focus:ring-indigo-200 transition-all p-3 outline-none appearance-none"
            >
      ...
      <div className="space-y-6">
        ...
        <div className="space-y-2">
          ...
          <textarea
            ...
            onChange={handleChange}
            rows={2}
            className="w-full rounded-lg border-gray-200 bg-gray-50 focus:bg-white focus:border-indigo-500 focus:ring-2 focus:ring-indigo-200 transition-all p-3 outline-none resize-none"
